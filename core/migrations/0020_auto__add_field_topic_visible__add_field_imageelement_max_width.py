...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageElement.max_width'
        db.add_column(u'core_imageelement', 'max_width',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ImageElement.max_width'
        db.delete_column(u'core_imageelement', 'max_width')
