...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_lesson', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='lessons', to=orm['core.Course']),
                      keep_default=False)

        # Adding field 'Lesson._order'
        db.add_column(u'core_lesson', '_order',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_lesson', '_order')
