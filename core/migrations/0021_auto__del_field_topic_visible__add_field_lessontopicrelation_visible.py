...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_topic', 'visible')

        # Adding field 'LessonTopicRelation.visible'
        db.add_column(u'core_lessontopicrelation', 'visible',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_topic', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'LessonTopicRelation.visible'
        db.delete_column(u'core_lessontopicrelation', 'visible')
    ...
    models = {
        ...
        u'core.topic': {
            ...
            'caption': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
