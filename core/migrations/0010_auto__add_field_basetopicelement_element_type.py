...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseTopicElement.element_type'
        db.add_column(u'core_basetopicelement', 'element_type',
                      self.gf('django.db.models.fields.CharField')(default='not-a-valid-type', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseTopicElement.element_type'
        db.delete_column(u'core_basetopicelement', 'element_type')
