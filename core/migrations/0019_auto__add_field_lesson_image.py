...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_lesson', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='no-img.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.image'
        db.delete_column(u'core_lesson', 'image')
