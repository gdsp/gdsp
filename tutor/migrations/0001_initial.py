...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Result'
        db.create_table(u'tutor_result', (
            ...
            ('csd', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('cheated', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
